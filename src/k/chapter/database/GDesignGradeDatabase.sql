...
(classid,
 classname)
VALUES (1,
        "class a - xi standard (biology)");

INSERT INTO class
(classid,
 classname)
VALUES (2,
        "class b - xi standard (computer)");

INSERT INTO class
(classid,
 classname)
VALUES (3,
        "class c - xi standard (statistics)");

INSERT INTO class
(classid,
 classname)
VALUES (4,
        "class d - xi standard (commerce)");
...
CREATE TABLE classcoursemap
(
  classid  INT,
  courseid INT
);

INSERT INTO classcoursemap
(classid,
 courseid)
VALUES (1,
        1);
...
SELECT Count(*)
FROM (SELECT studentgrade.studentid
      FROM studentgrade
      GROUP BY studentgrade.studentid);
...
WHERE rownum <= Ceil(((SELECT Count(*)
                       FROM (SELECT studentgrade.studentid
                             FROM studentgrade
                             GROUP BY studentgrade.studentid)) * 10) / 100
);